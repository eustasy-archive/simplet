...
if ( !$Topic_Create ) {
	array_push($Return['Errors'], 'Invalid Query (Topic_Create): '.mysqli_error($Database['Connection']));
}
...
if ( !$Topic_Delete ) {
	array_push($Return['Errors'], 'Invalid Query (Topic_Delete): '.mysqli_error($Database['Connection']));
}
