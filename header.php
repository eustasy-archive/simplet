...
<head>
	...
	<!--[if lt IE 9]>
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,selectivizr,prefixfree,jquery@1.11.0,jquery.equalize,jquery.downboy,jquery.cookie');</script>
	<![endif]-->
	<!--[if IE 9]><!-->
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,prefixfree,jquery,jquery.equalize,jquery.downboy,jquery.cookie');</script>
	<!--<![endif]-->
	<script>
		$(function(){
			equalize();
