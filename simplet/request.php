...
require 'functions/member.change.mail.php';
require 'functions/member.change.mail.form.php';
require 'functions/member.change.name.php';
require 'functions/member.change.name.form.php';
require 'functions/member.change.pass.php';
require 'functions/member.change.pass.form.php';
require 'functions/member.delete.php';
require 'functions/member.delete.form.php';
...
require 'functions/member.sessions.php';
