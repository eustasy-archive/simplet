...
if ($Request['path'] === $Place['path'].$Canonical) {
	...
	<p><strong><a href="https://github.com/eustasy/simplet/issues/47">Non-secure cookies</a>:</strong> Cookies should respond according to the protocol used. Check it does not interfere with JavaScript access, which we will be using later. <strong>Fixed in <a href="https://github.com/eustasy/simplet/commit/a7b91d948e6eb879120902c9c076ecf44a18d9ed">a7b91d9</a>, due for release as part of version 5.</strong></p>
	<p><strong>SQL Injection: <a href="https://github.com/eustasy/simplet/issues/39">Inputs with a <code>\</code> are not properly escaped</a>:</strong> This issue could have caused a variety of posting issues, and could have been the key to far greater SQL-based attacks. <strong>Fixed with the <a href="https://github.com/eustasy/simplet/commit/216ac0458a99f10285f8e2586def6d74a626047c">addition of a function</a> and the <a href="https://github.com/eustasy/simplet/commit/f26f481a3690205dbdcc6d9c30438abfc881a528">replacement throughout</a>.</strong></p>
