...
function ViewCount() {
	...
	// Set some Globals
	global $Database, $Canonical, $Member_Auth, $Member_ID, $Member_Admin, $Time, $Place, $Post_Type, $Sitewide_Root, $User_IP, $User_Cookie;
	...
	if (!$View) exit('Invalid Query (View): '.mysqli_error($Database['Connection']));
