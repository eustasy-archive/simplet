...
if ($Request['path'] === $Place['path'].$Canonical) {
	...
	<p><strong><a href="https://github.com/eustasy/simplet/issues/47">Non-secure cookies</a>:</strong> Cookies should respond according to the protocol used. Check it does not interfere with JavaScript access, which we will be using later. <strong>Known to affect All Versions.</strong></p>
	<h6>Won't Fix</h6>
