...
function Forum_Topic_Slug($Topic_Slug) {
	...
	$Characters_Special = '~&([a-z]{1,2})(?:acute|cedil|circ|grave|lig|orn|ring|slash|th|tilde|uml);~i';
	$Topic_Slug = preg_replace($Characters_Special, '$1', $Topic_Slug);
	...
	$Characters_Special = 'àáâãäåòóôõöøèéêëðçìíîïùúûüñšž';
	$Characters_Replace = 'aaaaaaooooooeeeeeciiiiuuuunsz';
