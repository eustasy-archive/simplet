...
<head>
	...
	<!--[if lt IE 9]>
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,selectivizr,jquery@1.11.0,jquery.equalize');</script>
	<![endif]-->
	<!--[if IE 9]><!-->
		<script>jQl.loadjQ('//cdn.jsdelivr.net/g/modernizr,jquery,jquery.equalize');</script>
	<!--<![endif]-->
	<script>
		$(function(){
			equalize();
